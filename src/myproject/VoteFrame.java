...
public class VoteFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        vote_label.setText("Which team won IPL 2024? ");

        buttonGroup1.add(vote1_button);
        vote1_button.setText("CSK");
